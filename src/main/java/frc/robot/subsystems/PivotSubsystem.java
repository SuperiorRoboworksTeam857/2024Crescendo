...
public class PivotSubsystem extends SubsystemBase {
  ...
  private static final double horizontalAngle = 0.661 + 0.029;
  private static final double angledSubwooferAngle = 0.655  + 0.029;
  private static final double shallowerAngle = 0.63  + 0.029;   // 0.62 around white lines, 0.64 around middle of black tape
  private static final double verticalAngle = 0.416  + 0.029;
  ...
  public void goToAngle(Positions position) {
    switch (position) {
      case HORIZONTAL:
        ...
        break;
      case SUBWOOFER_ANGLE:
        m_goalAngle = angledSubwooferAngle;
        break;
      case SHOT_ANGLE:
        m_goalAngle = shallowerAngle;
        break;
      case VERTICAL:
